...
images = pipe(
        ...
        height=600,
        width=600,
        negative_prompt = "low quality, worst quality, blurry, jpeg artifacts,identity drift, inconsistent appearance, mixed characters,deformed face, distorted face,extra limbs, extra fingers, missing fingers, bad anatomy, mutation",
        seed=1234,
        guidance_scale=15.0,
        inter_subject_k = 2,
